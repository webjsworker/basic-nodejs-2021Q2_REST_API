...
var boardsService = require('./boards.service');
router.route('/').get(function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var boards;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, boardsService.getAll()];
            case 1:
                boards = _a.sent();
                return [4 /*yield*/, res.json(boards.map(Board.toResponse))];
            case 2:
                _a.sent();
                return [2 /*return*/];
        }
...
router.route('/:id').get(function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, boardsService.getById(req.params.id)];
            case 1:
                board = _a.sent();
                if (!board) {
                    res.status(404).json();
...
router.route('/:id').delete(function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, boardsService.deleteById(req.params.id)];
            case 1:
                _a.sent();
                res.sendStatus(200);
                return [2 /*return*/];
...
router.route('/').post(function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, boardsService.creat(req.body)];
            case 1:
                board = _a.sent();
...
router.route('/:id').put(function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, boardsService.change(req.params.id, req.body)];
            case 1:
                board = _a.sent();
                res.status(200).send(board);
                return [2 /*return*/];
